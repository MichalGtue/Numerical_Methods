...
ax75.set_title('Figure 7.5: Probability density function 3D projection at 500 steps', size=6, weight='bold')
ax75.set_xlabel('x')
ax75.set_ylabel('y')
ax75.set_zlabel('pdf')
...
ax76.set_title('Figure 7.6: Histogram for prisoner positions after the last step', size=6, weight='bold')
ax76.set_xlabel('x')
ax76.set_ylabel('y')
ax76.set_xlim(-15, 15)
ax76.set_ylim(-15,15)
