...
#This file computes the error and rate of convergence. The file 'Task 5,2' shows the maximum time step for a stable solution
...
# We can se that as Nt increases, the rate of convergence approaches 1. This alligns with the expected results